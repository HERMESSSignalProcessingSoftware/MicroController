...
/* Definitions for DataGattering */
osThreadId_t DataGatteringHandle;
const osThreadAttr_t DataGattering_attributes = { .name = "DataGattering",
		.priority = (osPriority_t) osPriorityNormal, .stack_size = 128 * 4 };
/* Definitions for DataOutput */
osThreadId_t DataOutputHandle;
const osThreadAttr_t DataOutput_attributes = { .name = "DataOutput", .priority =
		(osPriority_t) osPriorityNormal, .stack_size = 128 * 4 };
/* Definitions for HeartBeat */
osThreadId_t HeartBeatHandle;
const osThreadAttr_t HeartBeat_attributes = { .name = "HeartBeat", .priority =
...
/* USER CODE BEGIN Header_DataOutputTask */
/**
