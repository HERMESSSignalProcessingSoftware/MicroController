...
#define USB2_UNCOMPRESSED_MAXIMAL_FRAME_SIZE    (2*640*320)
#define USB2_UNCOMPRESSED_WIDTH                 640
#define USB2_UNCOMPRESSED_HIGH                  320
#define USB2_UNCOMPRESSED_FPS                   15
#define USB2_UNCOMPRESSED_FPS_REG               (10^7/USB2_UNCOMPRESSED_FPS)
...
const uint8_t CyFxUSBHSConfigDscr[] =
    {
       ...
       /* Class specific Uncompressed VS Frame descriptor */
        ...
        CUT0B(USB2_UNCOMPRESSED_WIDTH),
        CUT1B(USB2_UNCOMPRESSED_WIDTH),          /* Width in pixel */
        CUT0B(USB2_UNCOMPRESSED_HIGH),
        CUT1B(USB2_UNCOMPRESSED_HIGH),          /* Height in pixel*/
        ...
        CUT0B(USB2_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),/* Maximum video or still frame size in bytes(Deprecated)*/
        CUT1B(USB2_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),
        CUT2B(USB2_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),
        CUT3B(USB2_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),
        CUT0B(USB2_UNCOMPRESSED_FPS_REG),
        CUT1B(USB2_UNCOMPRESSED_FPS_REG),
        CUT2B(USB2_UNCOMPRESSED_FPS_REG),
        CUT3B(USB2_UNCOMPRESSED_FPS_REG),         /*fps */
...
#define USB3_UNCOMPRESSED_WIDTH               FACETANDVISION_USB_OUTPUT_WIDTH
#define USB3_UNCOMPRESSED_HIGH                FACETANDVISION_USB_OUTPUT_HIGH
#define USB3_UNCOMPRESSED_MAXIMAL_FRAME_SIZE  (2*USB3_UNCOMPRESSED_WIDTH*USB3_UNCOMPRESSED_HIGH)
#define USB3_UNCOMPRESSED_FPS                 15
#define USB3_UNCOMPRESSED_FPS_REG             (10^7/USB3_UNCOMPRESSED_FPS)
...
const uint8_t CyFxUSBSSConfigDscr[] =
    {
       ...
       /* Class-specific Video Streaming Input Header Descriptor */
        ...
        0x01,                           /* Frame Descriptor Index */
        0x03,                           /* Still image capture method 1 supported, fixed frame rate */
        CUT0B(USB3_UNCOMPRESSED_WIDTH),
        CUT1B(USB3_UNCOMPRESSED_WIDTH),       /* Width in pixel */
        CUT0B(USB3_UNCOMPRESSED_HIGH),
        CUT1B(USB3_UNCOMPRESSED_HIGH),         /* Height in pixel */
        0x00,0x50,0x97,0x31,            /* Min bit rate bits/s. */
        0x00,0x50,0x97,0x31,            /* Max bit rate bits/s. */

        CUT0B(USB3_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),/* Maximum video or still frame size in bytes(Deprecated)*/
        CUT1B(USB3_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),
        CUT2B(USB3_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),
        CUT3B(USB3_UNCOMPRESSED_MAXIMAL_FRAME_SIZE),

        CUT0B(USB3_UNCOMPRESSED_FPS_REG),
        CUT1B(USB3_UNCOMPRESSED_FPS_REG),
        CUT2B(USB3_UNCOMPRESSED_FPS_REG),
        CUT3B(USB3_UNCOMPRESSED_FPS_REG),         /*fps */
        0x01,
        0x15,0x16,0x05,0x00,
